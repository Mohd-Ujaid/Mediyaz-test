                    ...
                    <td className="p-4 text-center">
                      <div className="flex justify-center items-center gap-2">
                        <Button
                          ...
                          size="icon-xs"
                          variant="outline"
                          className="rounded-lg h-7 w-7 text-xs cursor-pointer border-slate-200 hover:bg-slate-50"
                        >
                        ...
                        {req.status === "PENDING" && (
                          <>
                            <Button
                              ...
                              size="icon-xs"
                              className="rounded-lg h-7 w-7 text-xs bg-emerald-600 text-white hover:bg-emerald-700 cursor-pointer"
                              title="Approve allocation request"
                            >
                            ...
                            <Button
                              ...
                              size="icon-xs"
                              className="rounded-lg h-7 w-7 text-xs bg-rose-600 text-white hover:bg-rose-700 cursor-pointer"
