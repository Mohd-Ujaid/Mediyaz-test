...
import { Plus, RefreshCw, Edit, Trash2, X } from "lucide-react";
                ...
                {articles.map((art) => (
                  <tr key={art._id} className="hover:bg-slate-50/50 dark:hover:bg-slate-900/50">
                    ...
                    <td className="p-3 text-right flex justify-end gap-1">
                      <Button onClick={() => openEditModal(art)} size="sm" variant="ghost" className="h-7 w-7 p-0 rounded-lg text-blue-500 hover:text-blue-600 hover:bg-blue-50 dark:hover:bg-blue-900/50">
                        <Edit className="w-3.5 h-3.5" />
                      </Button>
                      <Button onClick={() => handleDelete(art._id)} size="sm" variant="ghost" className="h-7 w-7 p-0 rounded-lg text-red-500 hover:text-red-600 hover:bg-red-50 dark:hover:bg-red-900/50">
