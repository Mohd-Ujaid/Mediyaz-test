              ...
              <tbody className="divide-y divide-slate-100 dark:divide-slate-900">
                {paginatedEmployees.map((emp) => (
                  <tr key={emp._id} className="hover:bg-slate-50/50 dark:hover:bg-slate-900/50 group">
                    ...
                    <td className="p-3.5 text-right flex justify-end gap-1 print:hidden">
                      <Button 
                        size="sm" 
                        variant="ghost" 
                        onClick={() => { setSelectedEmp(emp); setIsDetailOpen(true); }}
                        className="h-7 w-7 p-0 rounded-lg text-slate-600 hover:text-teal-500"
            ...
            <div className="space-y-1.5 border-t pt-3 dark:border-slate-800">
              ...
              <div className="grid grid-cols-2 gap-2 mt-1 bg-slate-50 dark:bg-slate-950 p-2.5 rounded-xl border dark:border-slate-850">
                {[
                  ...
                  { key: "VIEW_REFERRALS", label: "Referrals" },
                  { key: "VIEW_SERVICES", label: "Services" },
                  { key: "VIEW_BOOKINGS", label: "Appointments" },
                  { key: "VIEW_FEEDBACK", label: "Reviews" },
